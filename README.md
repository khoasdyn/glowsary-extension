...
Open `manual-test.html` in Chrome after loading the extension. Save terms such as `love`, `get`, `get it`, and `get in` to verify exact matching, longer-match priority, phrase spacing, editable-area skipping, and dynamic content highlighting.
