...
- `product-planner`: Product planning and documentation mode for this project. Use only when the user explicitly invokes it by name. Owns PRD, product thinking, critique, NOTES.md, and non-design build plans.
